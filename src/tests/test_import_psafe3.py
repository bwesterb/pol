        ...
        self.assertEqual(pol.importers.psafe3.load(StringIO.StringIO(TEST_SAFE),
            ...
            ({'last-save': datetime(2013, 4, 3, 11, 11, 50),
             ...
             [{'group': 'group.sub group',
               'password': '[G2&#oRpAWVF',
               'password-modification-time': datetime(2013, 4, 3, 11, 10, 57),
               'title': 'testing',
               'username': 'user',
              ...
              {'group': 'group',
               ...
               'password': '(?E[7bET-7zi',
               'password-modification-time': datetime(2013, 4, 3, 11, 10, 49),
               'title': 'another test',
               'username': '',
               'uuid': UUID('1ed6b055-d0b1-c377-caac-c51bad0ae6d0')},
              {'password': '%-|lez&h\\6tO',
               'password-modification-time': datetime(2012, 8, 9, 22, 33, 37),
               'title': 'Hallo',
               'url': 'omg',
               'username': 'wee',
              ...
              {'email-address': 'waa@mail.com',
               ...
               'notes': 'RARA',
               'password': 'G!?1[9I~u<,M',
               'password-modification-time': datetime(2012, 8, 9, 22, 33, 49),
               'title': 'Wee',
               'url': 'woo',
               'username': 'waa',
              ...
              {'email-address': 'wee',
               ...
               'notes': 'wee',
               'password': ':9cUzL[lq?}?',
               'password-modification-time': datetime(2012, 8, 9, 22, 33, 57),
               'title': 'title',
               'url': 'wee',
               'username': 'lol',
